...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bouygues server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Bouygues server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bouygues features */
        {"byg", "masternode", &masternode, true, true, false},
        {"byg", "listmasternodes", &listmasternodes, true, true, false},
        {"byg", "getmasternodecount", &getmasternodecount, true, true, false},
        {"byg", "masternodeconnect", &masternodeconnect, true, true, false},
        {"byg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"byg", "masternodedebug", &masternodedebug, true, true, false},
        {"byg", "startmasternode", &startmasternode, true, true, false},
        {"byg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"byg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"byg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"byg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"byg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"byg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"byg", "mnbudget", &mnbudget, true, true, false},
        {"byg", "preparebudget", &preparebudget, true, true, false},
        {"byg", "submitbudget", &submitbudget, true, true, false},
        {"byg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"byg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"byg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"byg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"byg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"byg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"byg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"byg", "checkbudgets", &checkbudgets, true, true, false},
        {"byg", "mnsync", &mnsync, true, true, false},
        {"byg", "spork", &spork, true, true, false},
        {"byg", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"byg", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bygd, or the -server option to byg-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Bouygues Alert\" admin@foo.com\n"),
...
{
    return "> byg-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:44253/\n";
}
